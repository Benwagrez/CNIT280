<div class="flexContainer" style="margin: 0; padding: 0; position: relative; top: 0;">
    ...
    <div class="flexItemStart" id="bugFlexItem">
        <h3 style = "text-align: left;">TEST</h3>
        <p>TEST</p>
        <p>TEST<a href="howToUse.php" style="color: white">TEST</a></p><!--By using the site and reporting errors and/or bugs, you are giving experience to the current computer science students at Lake Park.</p>-->
    </div>
